...
class BeamSearchDecoder(object):
    ...
    def __init__(self, opt, models, beam_size=1):
        """Initialize model."""
        self.opt = opt
    ...
    def _load_model(self, models):
        self.embed = models['embed']
        self.output_projector = models['output_projector']
        self.core = models['core']
        self.logit = models['logit']
...
class GreedyDecoder(object):
    ...
    def translate(self):
        ...
        for j in range(
            ...
            input_lines_trg_gold = Variable(
                input_lines_trg_gold.data, volatile=True)
            output_lines_trg_gold = Variable(
                output_lines_trg_gold.data, volatile=True)
            mask_src = Variable(mask_src.data, volatile=True)
